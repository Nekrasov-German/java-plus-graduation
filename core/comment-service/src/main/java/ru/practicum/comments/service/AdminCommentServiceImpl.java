...
public class AdminCommentServiceImpl implements AdminCommentService {
    ...
    public List<CommentAdminDto> getAllComments(Long eventId, Long userId, String text, Pageable pageable) {
        ...
        if (eventId != null && userId != null) {
            comments = commentRepository.findAllByEventAndAuthorOrderByCreatedOnDesc(eventId, userId, pageable);
        } else if (eventId != null) {
            comments = commentRepository.findByEventOrderByCreatedOnDesc(eventId, pageable);
        } else if (userId != null) {
            comments = commentRepository.findAllByAuthorOrderByCreatedOnDesc(userId, pageable);
